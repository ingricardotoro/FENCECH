...
import breadcrumbBg2 from '../../../../public/assets/images/breadcrumb/directiva.jpeg'

interface BreadCrumbType{
    breadcrumbTwoTitle:string
}
const BreadcrumbNosotros = ({breadcrumbTwoTitle}:BreadCrumbType) => {
    return (
...
export default BreadcrumbNosotros;