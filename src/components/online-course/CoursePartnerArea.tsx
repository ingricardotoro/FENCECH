                    ...
                    <div className="col-xl-5 col-lg-5 col-md-12">
                        <div className="bd-section-title-wrapper">
                            <h2 className="bd-section-title mb-20">
                                Nuestros <span className="down-mark-line">Alianzas</span> Estrategicas
                            </h2>
                            <p className="bd-section-paragraph">
                                Organizaciones y empresas que nos acompañan al cumplimiento de nuestra visión.
                            </p>
                            <p className="bd-section-paragraph">
                                <span className="text-primary fs-18 fw-6">16,500</span>+ Estudianes
                                &amp; ha sido impactados.
                            </p>
                        </div>
                    </div>
