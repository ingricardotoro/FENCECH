...
const testimonialData: ITestimonial[] = [
    {
        id: 1,
        rating: 5,
        content: "Junto a la orientación dada por FENCECH hemos crecido como Institucion Católica Educativa.",
        name: "Sarah Johnson",
        avatar: avatar1,
    },
    {
        id: 2,
        rating: 5,
        content: "Gracias al acompañamiento y formación de FENCECH hemos mejorado la calidad de educación. ",
        name: "James Parker",
        avatar: avatar2,
    },
    {
        id: 3,
        rating: 5,
        content: "Nuestros docentes y estudiantes se han visto beneficiado gracias a las formaciones dadas por FENCECH.",
        name: "Emily Davis",
        avatar: avatar3,
    },
