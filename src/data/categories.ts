import { ICategories, IFines, ISchoolinCategories } from "@/interFace/interFace";
...
export const finesData: IFines[] = [
    //Course Online categories data start
    {
        id: 1,
        title: "Difundir el Evangelio",
        totalCourses: 'Trabajar para que sea una realidad en Honduras',
        icon: ArtsDesignSvg
    },
    {
        id: 2,
        title: "Fomentar Valores",
        totalCourses: "Justicia, Solidaria y Fraterna",
        icon: WebDevelopmentSvg
    },
    {
        id: 3,
        title: "Promover Objetivos",
        totalCourses: 'Apostólicos, Medio Ambiente, Calidad',
        icon: PhotographySvg
    },
    {
        id: 4,
        title: "Misión Evangelizadora",
        totalCourses: 'Real Educación en la Fe',
        icon: BusinessAnalysisSvg
    },
    {
        id: 5,
        title: "Atención a los Pobres",
        totalCourses: 'Por medio de la labor educativa.',
        icon: DigitalMarketingSvg
    },
    {
        id: 6,
        title: "Difundir Documentos",
        totalCourses: 'Brindados por la iglesia, para la educación',
        icon: DataScienceSvg
    },
    {
        id: 7,
        title: "Libertad de Educación",
        totalCourses: 'Jesucristo como modelo.',
        icon: HealthFitnessSvg
    },
    {
        id: 8,
        title: "Fomentar la Unión",
        totalCourses: 'Entre las Instituciones afiliadas.',
        icon: DanceMusicSvg
    }
];
